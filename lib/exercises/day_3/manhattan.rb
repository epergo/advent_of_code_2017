...
module Day3
  ...
  class Manhattan
    ...
    def generate_side(min_value, max_value)
    ...
    def initial_manhattan_distance(level)
      2 * (level - 1) + 1
    end

    def calculate_side_size(side)
      side.size / 4
    end

    def manhattan_distances_of_a_side(initial, size_of_side)
